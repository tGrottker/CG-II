...
class Raytracer extends Painter{
  ...
  */
  ...
  scene.addShape(ColoredPlane(new Vector(0,-0.5F,0), new Vector(0,1,0), new ColorMaterial(new Color(0,0.5F,0.5F)), scene))
  ...
  scene.addLight(new PointLight(new Vector(0, 3, 0.5F), new Color(0.8F,0.8F,0.8F)))
