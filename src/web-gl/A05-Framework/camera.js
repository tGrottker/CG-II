...
Camera = function() {
    ...
    */
    this.lookAt = function(eye,target,up) {
        ...
        window.console.log("Camera.lookat("+eye+" --> "+target+")");
    }
    
    /* 
        translate the camera's eye point, in camera coordinates
        - trans [3 floats]: translation vector
    */
    this.translate = function(trans) {
        var t = mat4.identity();
        mat4.translate(t,trans,t);
        // translation in eye coords means multiply from the LEFT
        mat4.multiply(t,this.toEye,this.toEye);
    }
